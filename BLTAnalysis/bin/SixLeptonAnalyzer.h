...
#ifndef SIXLEPTONANALYZER_HH
#define SIXLEPTONANALYZER_HH
...
class SixLeptonAnalyzer: public BLTSelector {
public:
    SixLeptonAnalyzer();
    ~SixLeptonAnalyzer();
    ...
    // Histograms
    TH1D *hSixLeptonEvents, *hFiducialEvents;
...
//  std::vector<Float_t>    qcdWeight,  pdfWeight;
    ...
    //ClassDef(SixLeptonAnalyzer,0);
};


#endif  // SIXLEPTONANALYZER_HH
