...
void smearElectron()
{
    ...
    TString inName = "../data/CombinedMethod_ScaleFactors_RecoIdIsoSip.root";

    TFile   *inFile = TFile::Open(inName);

    TH2     *h_sf;
    inFile->GetObject("h_electronScaleFactor_RecoIdIsoSip", h_sf);
    h_sf->SetDirectory(0);
    ...
    TString outName = "../data/electron_id_smear_2012.root";
